...
from app.api.v1 import projects, sources, generation, qa_pairs, export, ollama, websocket, llm_review, llm_providers
...
router.include_router(llm_review.router, tags=["LLM Review"])
router.include_router(llm_providers.router, tags=["LLM Providers"])
